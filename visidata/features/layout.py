__description__ = "save, restore, and manage window layouts with pane splits"
__commands__ = ["resize-col-max", "resize-col-input", "resize-cols-max", "resize-cols-input", "hide-col", "resize-col-half", "hide-uniform-cols", "unhide-cols", "toggle-multiline", "resize-height-input", "resize-height-max"]
__menus__ = ["Column > Hide > Hide > hide-col", "Column > Hide > Hide uniform > hide-uniform-cols", "Column > Hide > Unhide all > unhide-cols", "Column > Resize > half width > resize-col-half", "Column > Resize > current column width to max > resize-col-max", "Column > Resize > current column width to N > resize-col-input", "Column > Resize > all columns width to max > resize-cols-max", "Column > Resize > all columns width to N > resize-cols-input", "Row > Resize > height to N > resize-height-input", "Row > Resize > height to max > resize-height-max", "View > Toggle display > multiline > toggle-multiline"]
